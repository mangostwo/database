...
BEGIN
  ...
  SET @cOldRev = 'required_21000_05_command'; 

  -- Set the new revision string
  SET @cNewRev = 'required_21000_06_mangos_string';
  ...
  IF @cThisRev = @cOldRev THEN
	...
	-- version
	INSERT IGNORE INTO `db_version` SET `Version` = 'MaNGOSTwo Database Rev 21000_06';
