...
BEGIN
    ...
    SET @cNewDescription = 'More_Draenei_Quest_relations';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'More_Draenei_Quest_relations';
...
-- UDB UPDATE [399] Draenei Zone - Quests relations.
-- Quests relations.
...
-- UDB UPDATE [322] Draenei Zone - more Quests relations.
-- Quests relations.
-- 9453 - Find Acteon! 
