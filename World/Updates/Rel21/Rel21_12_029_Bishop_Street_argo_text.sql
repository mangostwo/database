...
BEGIN
    ...
    SET @cNewDescription = 'Bishop Street argo text';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Bishop Street argo text';
...
UPDATE `creature_ai_scripts` SET `action3_type` = 1, `action3_param1` = -20909, `comment` = 'Bishop Street - Cast Holy Smite - Set Phase 1 and say on Aggro' WHERE `id` = 2724602;
