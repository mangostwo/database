...
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE entry IN (24792, 30527, 31143, 31144, 31146, 32541, 32542, 32543, 32545, 32546, 32666, 32667, 17578);
-- Remove 175178 and replace with correct training dummy
-- 175178 is missing from The Shattered Halls and will need to be researched
UPDATE `creature` SET `id` = '19139' , `spawntimesecs` = '300' , `curhealth` = '1524' WHERE `guid` = '86753'; 
