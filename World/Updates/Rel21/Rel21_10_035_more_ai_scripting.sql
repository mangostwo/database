...
BEGIN
    ...
    SET @cNewDescription = 'more ai scripting';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'more ai scripting';
    ...
    -- Firebrand Invoker
UPDATE creature_ai_scripts SET `event_type` = 0 WHERE creature_id  = 9262 AND `id` = 926210;

-- Wickerman Guardian
DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 15195;
