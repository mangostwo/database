...
-- replace with the correct value
UPDATE dbscripts_on_creature_movement SET dataint2 = 2000000405 WHERE id = 1723002 AND dataint2 = 2000000012;

-- replace with the correct value
UPDATE dbscripts_on_creature_movement SET dataint = 2000000406 WHERE id = 1723003 AND dataint = 2000000013;
