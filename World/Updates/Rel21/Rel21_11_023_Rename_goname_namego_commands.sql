...
BEGIN
    ...
    SET @cNewDescription = 'Rename goname-namego commands';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Renamed goname-namego commands to appear-summon';
...
DELETE FROM `command` where `name` like 'namego' or `name` like 'goname';
