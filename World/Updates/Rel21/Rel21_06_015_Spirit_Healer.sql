...
BEGIN
    ...
    SET @cNewDescription = 'Spirit_Healer';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Spirit_Healer';
    ...
    IF (@cCurResult = @cOldResult) THEN    -- Does the current version match the expected version
        ...
        -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -
-- UDB Update 541 Spirit Healer
SET @GUID := (SELECT MAX(guid) FROM `creature`);
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES 
(@GUID+1,6491,571,1,1,0,0,2002.742,5938.099,37.18986,5.934119,300,0,0,4120,0,0,0),
(@GUID+2,6491,571,1,1,0,0,2836.37,5979.3,114.197,4.88762,300,0,0,4120,0,0,0);
