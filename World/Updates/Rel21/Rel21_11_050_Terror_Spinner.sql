...
BEGIN
    ...
    SET @cNewDescription = 'Terror Spinner';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Terror Spinner';
...
DELETE FROM `creature` WHERE `id` = 32475;
INSERT INTO `creature` (`id`,`map`,`spawnMask`,`phaseMask`,`modelid`,`equipment_id`,`position_x`,`position_y`,`position_z`,`orientation`,`spawntimesecs`,`spawndist`,`currentwaypoint`,`curhealth`,`curmana`,`DeathState`,`MovementType`) VALUES
(32475,571,1,65535,0,0,6711.42,-4186.12,456.852,5.50739,28800,20,0,16502,0,0,1),
...
(32475,@Entry+1,0,'RARE Terror Spinner - 32475');
