...
BEGIN
    ...
    -- New Values
    SET @cNewVersion = '21';
    SET @cNewStructure = '13'; -- If The Update contains any 'ALTER DATABASE' statements, increment this and set cNewContent to 001
    SET @cNewContent = '001';
...
-- mangos 2
ALTER TABLE achievement_criteria_requirement ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE achievement_reward ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE dungeonfinder_requirements ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE item_convert ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE item_enchantment_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
ALTER TABLE item_expire_convert ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE locales_achievement_reward ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE milling_loot_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE spell_loot_template ROW_FORMAT=DYNAMIC ENGINE=INNODB;
...
ALTER TABLE vehicle_accessory ROW_FORMAT=DYNAMIC ENGINE=INNODB;
