...
DELETE FROM `db_script_string` WHERE `entry` BETWEEN 2000000944 AND 2000000947;
INSERT INTO `db_script_string` (`entry`,`content_default`,`sound`,`type`,`language`,`emote`,`comment`) VALUES
(2000000944, 'You call that a hammer strike? What kind of amateurs am I workin\' with here?', 0, 0, 0, 397, 'NPC - 25274'),
(2000000945, 'And WHAT are our soldiers supposed to do with that shoddy piece of junk?', 0, 0, 0, 397, 'NPC - 25274'),
(2000000946, 'You\'re an embarrassment to this entire operation! Pack up your stuff and get out!', 0, 0, 0, 397, 'NPC - 25274'),
(2000000947, 'You keep that garbage up and I\'ll ship you back to your momma in a box with a note strapped to your chest that reads: FAILURE.', 0, 0, 0, 397, 'NPC - 25274');
...
(3,@script_id+2, 5, 0, 0, 0, 0, 0, 0, 2000000944, 2000000945, 2000000946, 2000000947, 0, 0, 0, 0, 'NPC - 25274');

-- Borean Tundra - Warsong Hold

-- Durkot Wolfbrother
UPDATE `creature` SET `MovementType` = 2 WHERE `guid` = 125566;
DELETE FROM `creature_movement` WHERE `id` = 125566;
...
UPDATE `creature` SET `MovementType` = 2 WHERE `guid` = 125542;
DELETE FROM `creature_movement` WHERE `id` = 125542;
