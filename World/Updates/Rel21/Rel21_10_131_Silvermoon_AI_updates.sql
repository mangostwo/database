...
BEGIN
    ...
    SET @cNewDescription = 'Silvermoon AI updates';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Silvermoon AI updates';
...
UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `Entry` IN (18626,18627);
DELETE FROM `creature_ai_scripts` WHERE `creature_id` IN (18626,18627);
DELETE FROM `creature_ai_scripts` WHERE `id` = 1862902 AND `creature_id` = 18629;
