...
BEGIN
    ...
    SET @cNewDescription = 'Adding some conditions';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'Adding some conditions';
...
INSERT INTO `conditions` (`condition_entry`,`type`,`value1`,`value2`,`comments`) VALUE
...
DELETE FROM `conditions` WHERE `value1` = 20402;
INSERT INTO `conditions` (`condition_entry`,`type`,`value1`,`value2`,`comments`) VALUES 
(@condition+1, 2, 20402, 1, 'Player has 1 or more of Item ID 20402 in Inventory');
UPDATE `creature_loot_template` SET `ChanceOrQuestChance` = 80, `condition_id` = @condition+1 WHERE `item` = 20384 AND `ChanceOrQuestChance` = -80;
UPDATE `creature_loot_template` SET `ChanceOrQuestChance` = 100, `condition_id` = @condition+1 WHERE `item` = 20384 AND `ChanceOrQuestChance` = -100;
