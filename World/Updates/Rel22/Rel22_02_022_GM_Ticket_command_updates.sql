...
BEGIN
    ...
    SET @cNewDescription = 'GM_Ticket_command_updates';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'GM_Ticket_command_updates';
...
DELETE FROM `command` WHERE `id`=145;
DELETE FROM `command` WHERE `id`=680;
