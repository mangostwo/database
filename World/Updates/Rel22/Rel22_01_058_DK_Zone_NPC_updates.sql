...
BEGIN
    ...
    SET @cNewDescription = 'DK Zone NPC updates';

                        -- COMMENT is 150 Characters MAX
    SET @cNewComment = 'DK Zone NPC updates';
	...
	-- Scarlet Medic -- REDONE
	UPDATE `creature_ai_scripts` SET `action1_type` = 23, `action1_param1` = 1, `action1_param2` = 0, `action2_type` = 0, `action2_param1` = 0, `comment` = 'Scarlet Medic - Set Phase 1 on Aggro' WHERE `id` = 2860804;

	-- Scarlet Land Cannon
	DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 28850;
	...
	UPDATE `creature_template` SET `AIName` = 'EventAI' WHERE `entry` = 28850;

	-- Scarlet Fleet Defender
	DELETE FROM `creature_ai_scripts` WHERE `creature_id` = 28834;
	INSERT INTO `creature_ai_scripts` VALUES
